...
#               see Pfoch et al. (in review) for details.
...
#    - then estimate where a pixel average >= 50 % 
woody_500m_avg = stack(paste0(in_path, "woody_500m_avg_binary.tif"))
...
#    - then calculate 500 m buffer average of woody fraction
#    - then estimate where a pixel average >= 50 % 
nonwoody_500m_avg = stack(paste0(in_path, "nonwoody_500m_avg_binary.tif"))
...
wui_rs[impervious_500m_avg >= 0.2 & nonwoody_500m_avg == 1] = 3
# woody intermix WUI
wui_rs[impervious_500m_avg >= 0.2 & woody_500m_avg == 1] = 1
